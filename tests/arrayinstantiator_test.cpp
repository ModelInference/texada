...
TEST(ArrayInstantiatorTest,TwoBindingsThreeEvents){
	...
	texada::array_instantiator instantiator = texada::array_instantiator(events,*formula_vars);
	instantiator.instantiate_array();
	std::vector<texada::array_instantiator::inst_fxn> returned_array = instantiator.return_instantiations();
