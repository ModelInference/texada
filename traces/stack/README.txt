This log represents 87 executions of a stack. The system behind the log is the StackAr java example provided with Daikon, with its default runs.
...
args-ap-push.txt
This file provides the arguments to check which events always precede push.
