...
TEST(PrefixTreeTest,CreateSimpleTree) {
    ...
    texada::prefix_tree_node first_a = texada::prefix_tree_node("a", set0123);
    // first branch
    texada::prefix_tree_node first_b = texada::prefix_tree_node("b", set01);
    texada::prefix_tree_node first_c = texada::prefix_tree_node("c", set23);

    // first b branch
    texada::prefix_tree_node c_after_b = texada::prefix_tree_node("c", set0);
    texada::prefix_tree_node d_0 = texada::prefix_tree_node("d", set0);
    texada::prefix_tree_node terminal_0 = texada::prefix_tree_node(set0);
    //second b branch
    texada::prefix_tree_node d_after_b = texada::prefix_tree_node("d", set1);
    texada::prefix_tree_node e_1 = texada::prefix_tree_node("e", set1);
    texada::prefix_tree_node terminal_1 = texada::prefix_tree_node(set1);

    //first after c
    texada::prefix_tree_node e_after_c = texada::prefix_tree_node("e", set23);
    //first branch at e
    texada::prefix_tree_node e_2 = texada::prefix_tree_node("e", set2);
    texada::prefix_tree_node f_2 = texada::prefix_tree_node("f", set2);
    texada::prefix_tree_node terminal_2 = texada::prefix_tree_node(set2);
    //second branch at e
    texada::prefix_tree_node d_3 = texada::prefix_tree_node("d", set3);
    texada::prefix_tree_node terminal_3 = texada::prefix_tree_node(set3);
