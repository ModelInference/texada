...
from DefaultClassInfoHolder import DefaultClassInfoHolder
#to call daikon with
import subprocess
import collections
...
def main():
   ...
   for key in cih_dict:
     name = key.split(":")[0]
     filename = name + "-default-split.dtrace"
     f = open(filename, 'w')
   ...
   with open(filename) as f:
      ...
      for record in records:
         ...
         if (match_declPpt != None):
           ...
           obj_ppt_name_to_cih[split_record[0][4:]] = DefaultClassInfoHolder(split_record)
