...
def main():
   ...
   if args.split_to_logs:
     generate_data_temp_logs(traces, invars, args.ofile, args.incl_cls, args.incl_obj)
   else:
...
def generate_data_temp_logs(traces, invars, filepath, incl_cls, incl_obj):
   '''
   ...
   print extension
   for obj, trace in traces.iteritems():
      print filestart +  str(obj).strip(".") + extension 
